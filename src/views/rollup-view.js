...
class RollUpView extends LitElement {
  ...
  static get styles() {
    return [
      ...
      css`
        :host {
          background-image: url('assets/backgrounds/code.jpg');
        }
  ...
  render() {
    return html`
      <section>
          ...
          <a href="https://rollupjs.org" target="_blank" class="custom-link">rollup.js documentation</a>
      </section>
    `;
  }
}
